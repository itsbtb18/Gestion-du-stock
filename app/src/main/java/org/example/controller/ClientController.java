...
/**
 * Controller for Client management view
 * Handles client CRUD operations, loyalty program, and search
 */
public class ClientController {

    // FXML UI Components - Client Table
    ...
    private void selectClient(Client client) {
        ...
        totalAchatsLabel.setText(String.format("%.2f DH", client.getTotalAchats()));
    ...
    private void clearForm() {
        ...
        totalAchatsLabel.setText("0.00 DH");
    ...
    private void updateFormState() {
        ...
        codeField.setEditable(false); // Code is always read-only
        pointsField.setEditable(false); // Points managed separately
    }
